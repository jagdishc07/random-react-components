  ...
  return (
    <div className="w-full flex justify-center items-center flex-col gap-10 p-5 md:px-10">
      ...
      >
        ...
        {/* Box 5 */}
        <motion.div className="bg-foreground relative aspect-square rounded-lg flex-center">
          <div className="w-10 h-10 bg-white text-3xl">
            {[...Array(12).keys()].map((i) => {
              return (
                <motion.span
                  key={i}
                  className={`absolute left-[0.4629em] bottom-0 w-[0.074em] h-[0.2777em] `}
